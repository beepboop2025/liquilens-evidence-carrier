...
expected_version="${2:-0.18.0}"
cli_image="${LIQUILENS_CLI_IMAGE:-ghcr.io/beepboop2025/liquilens-evidence-carrier@sha256:293a9ec61ad43f9bac22775936271b19651b486115ab53acbe7928cb177f8c4e}"
expected_base_digest="${LIQUILENS_EXPECTED_BASE_DIGEST:-sha256:293a9ec61ad43f9bac22775936271b19651b486115ab53acbe7928cb177f8c4e}"
expected_release_revision="${LIQUILENS_EXPECTED_RELEASE_REVISION:-906ca033a96ea862ab813c64db2a6b01c5ce8c4f}"
smoke_dir="$(mktemp -d)"
